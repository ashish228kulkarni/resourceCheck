...
public class ResourceCheckApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(ResourceCheckApp.class);

    private final Environment env;

    public ResourceCheckApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes resourceCheck.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ResourceCheckApp.class);
